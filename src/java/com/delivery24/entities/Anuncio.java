 ...
 */
@Entity
@Table(name = "anuncio", catalog = "delivery24bd", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Anuncio.findByImagen", query = "SELECT a FROM Anuncio a WHERE a.imagen = :imagen")})
public class Anuncio implements Serializable {
    ...
    public Anuncio(Integer id, String imagen) {
        this.id = id;
        this.imagen = imagen;
    }
    ...
    public String toString() {
        return "com.delevery24.entities.Anuncio[ id=" + id + " ]";
    }
