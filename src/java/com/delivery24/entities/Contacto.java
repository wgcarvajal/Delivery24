 ...
 */
@Entity
@Table(name = "contacto", catalog = "delivery24bd", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Contacto implements Serializable {
    ...
    public Contacto(Integer id, String email, String nombre, String mensaje) {
        this.id = id;
        this.email = email;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.delivery24.entities.Contacto[ id=" + id + " ]";
    }
