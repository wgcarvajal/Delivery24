 ...
 */
@Entity
@Table(name = "administrador", catalog = "delivery24bd", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Administrador implements Serializable {
    ...
    public Administrador(Integer id, String nombre, String nombreusuario, String contrasena) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.delivery24.entities.Administrador[ id=" + id + " ]";
    }
