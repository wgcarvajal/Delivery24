...
{
    private Anuncio current;
    private DataModel items = null;
    @EJB
    private com.delivery24.facade.AnuncioFacade ejbFacade;
    ...
    private AnuncioFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Anuncio) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AnuncioCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AnuncioUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    public Anuncio getCiudad(java.lang.Integer id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Anuncio.class)
    public static class AnuncioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Anuncio) {
                Anuncio o = (Anuncio) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Anuncio.class.getName());
            }
        }
