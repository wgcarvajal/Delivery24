 ...
 * @author geovanny
 */
@Named(value = "pedidoDespachadoDetallesController")
@SessionScoped
public class PedidoDespachadoDetallesController implements Serializable {
   ...
   private Pedido pedidoSelected;
    ...
    public PedidoDespachadoDetallesController() 
    {
    ...
    public void seleccionarPedido(Pedido p) throws IOException
    {
        try
        {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("/delivery24/faces/pedidosdespachados/pedidodespachado.xhtml");
        }
        catch(IOException e)
        {
